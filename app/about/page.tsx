        ...
        <div className="w-full max-w-4xl mx-auto rounded-2xl shadow-lg border border-black/5 dark:border-white/5 overflow-hidden backdrop-blur-sm bg-background/70 p-8">
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold mb-2">Wahit Fitriyanto</h1>
              ...
              <p className="text-foreground/80 mb-4">
                Saya adalah seorang pengembang web berpengalaman dengan keahlian khusus dalam teknologi Next.js, React, dan pengembangan aplikasi AI. Dengan latar belakang yang kuat dalam bidang teknologi informasi, saya selalu berusaha mengembangkan solusi inovatif yang menggabungkan desain yang menarik dengan fungsionalitas yang powerful.
              </p>
              ...
              <div className="mb-6">
                <div className="mb-4 p-4 bg-background/50 rounded-lg border border-black/5 dark:border-white/5">
                  <h3 className="font-medium mb-1">Wahit AI</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="https://github.com/wahitfitr" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center sm:justify-start gap-2 px-4 py-2 bg-black text-white rounded-lg hover:opacity-90 transition-opacity">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
